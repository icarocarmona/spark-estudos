...
Não foi testado na versão 7 do java
...
Obs.: Baixe os arquivos antes de tudo pois são grandes
...
- `Obs.: Não deve colocar a pasta bin no Value.`

### Dependências utilizadas
 - spark-core_2.12, versão 2.4.0 (Necessario para rodar o spark)
 - paranamer, versão 2.8 (necessário por causa da utilização do Java8 e pois se utilizar o método parallelize da class JavaSparkContext sem essa dependência vai dar erro)
